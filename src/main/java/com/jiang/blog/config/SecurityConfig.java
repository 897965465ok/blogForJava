...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
         ...
         * 允许匿名访问 ,登录后不能访问 anonymous()
         * permitAll() 匿名可访问 登陆后可访问
         */
        ...
        http.cors()
                ...
                .authorizeRequests()
                // 对于登录接口
                .antMatchers("/v1/login","/v1/register")
                .permitAll()
                .antMatchers(HttpMethod.GET, "/v1/articles","/v1/tags")
                .permitAll()
                // 除上面外的所有请求全部需要鉴权认证
                .anyRequest()
                .authenticated();
...
/*
    private String password() {
        return PasswordEncoder.encode("密码");
    }
*/
